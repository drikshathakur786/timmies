      ...
      <div className="section-wrapper" style={{ position: 'relative', zIndex: 10, paddingTop: '10rem', paddingBottom: '6rem' }}>
        ...
        >
          ...
          <p style={{
            ...
            Tim Hortons has been part of the Canadian fabric since 1964. From a single location in Hamilton, Ontario, we have grown to over 5,700 locations coast to coast.
          </p>
        </motion.div>

  ...
  return (
    ...
    >
      <div style={{
        background:           selected
          ? 'rgba(200,16,46,0.08)'
          : 'rgba(255,245,228,0.03)',
        backdropFilter:       'blur(20px)',
        WebkitBackdropFilter: 'blur(20px)',
        border:               '1px solid ' + (selected
          ? 'rgba(200,16,46,0.3)'
          : 'rgba(255,245,228,0.07)'),
        borderLeft:           selected
          ? '3px solid #C8102E'
        ...
        boxShadow:            selected
          ? '0 8px 24px rgba(200,16,46,0.15)'
        ...
        <div style={{
          ...
          <div style={{
            ...
            alignItems:   'center',
            gap:          '5px',
            background:   location.isOpen
              ? 'rgba(34,197,94,0.12)'
              : 'rgba(239,68,68,0.12)',
            border:       '1px solid ' + (location.isOpen
              ? 'rgba(34,197,94,0.25)'
              : 'rgba(239,68,68,0.25)'),
            borderRadius: '100px',
            padding:      '3px 8px',
            ...
            <span style={{
              fontFamily: 'var(--font-body)',
              fontSize:   '0.62rem',
              color:      location.isOpen ? '#22C55E' : '#EF4444',
              fontWeight: 500,
            }}>
        ...
        <div style={{
          ...
          {location.distance && (
            <>
              <span style={{ color: 'rgba(255,245,228,0.15)', margin: '0 2px' }}>·</span>
              <span style={{
                fontFamily: 'var(--font-body)',
                fontSize:   '0.72rem',
                color:      '#C8102E',
